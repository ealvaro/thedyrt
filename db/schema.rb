...
ActiveRecord::Schema.define(version: 20_210_711_142_655) do
  ...
  create_table "booked_dates", force: :cascade do |t|
    ...
    t.index ["campsite_id"], name: "index_booked_dates_on_campsite_id", using: :btree
  end
  ...
  add_foreign_key "booked_dates", "campsites"
